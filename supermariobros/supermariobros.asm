...
play_note:
 ldx which_element
 lda super_mario_bros_music_data, x
 sta notelength

 lda counter
 cmp #41 ; elements count
 bne start_note
...
background:
  ...
  .db $24,$24,$24,$24,$24,S0,U0,P0,E0,R0,$24,M0,A0,R0,I0,O0,$24,B0,R0,O0,S0,$24,M0,U0,S0,I0,C0,$24,$24,$24,$24,$24  ;;
...
super_mario_bros_music_data: ; note length, volume, sign (not used), note value square 1, note value square 2, note value triangle
  ; Part 1
  .db 8,145,F4,E5,0
  .db 16,145,F4,E5,0
  .db 12,145,F4,E5,0
